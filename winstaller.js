...
function getInstallerConfig () {
  ...
  return Promise.resolve({
    appDirectory: path.join(rootPath, 'Flora-win32-x64'),
    ...
    exe: 'Flora.exe',
    setupExe: 'FloraSetup-' + process.env.FLORA_INSTALLER_VERSION + '.exe',
    setupIcon: path.join(rootPath, 'src', 'assets', 'img', 'flora.ico')
  })
}
