...
import { CardHero, Link } from '@flora/core';
import { PlotHero as PlotHeroIcon } from '@flora/icons';
      ...
      <Grid xs={12} md={6} lg={4} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Flora. '
              }
              <Link
                target="_blank"
