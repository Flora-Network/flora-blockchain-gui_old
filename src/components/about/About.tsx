...
import icon from '../../assets/img/flora_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Flora Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Flora-Network/flora-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
