...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of flora', () => {
      const result = units.getUnit('flora');
    ...
    it('supports uppercase characters', () => {
      const result = units.getUnit('XFLCOIN');

      expect(result).toBe(1);
    });
    it('gets unit of flora using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of flora', () => {
      const result = units.getDisplay('flora');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('flora', 9);

      const result = units.getUnit('flora');

      expect(result).toEqual(9);

      units.setUnit('flora', 1);
    });
  });
  describe('#setDisplay', () => {
